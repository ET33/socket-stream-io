...
int main(int argc, char * const argv[]) {
	...
	// args.ss = processSounds(&args.msg_recv, &args.process_end, args.music_dir, 0);
	...
	pthread_create(&args.recv_thread, NULL, server_recv_data, (void *) &args);
	pthread_create(&args.send_thread, NULL, server_send_data, (void *) &args);
